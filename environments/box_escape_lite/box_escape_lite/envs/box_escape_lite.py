...
class BoxEscapeLite(Env):
    ...
    def __init__(
        ...
        self.GOAL_COLORS: Dict[int, Tuple[int, int, int]] = {
            1: (165, 172, 63),  # Correct goal if 1 box - 1 * 63 = 64
            2: (165, 172, 126),  # Correct goal if 2 boxes - 2 * 63 = 126
            3: (165, 172, 189),  # Correct goal if 3 boxes - 3 * 63 = 189
            4: (165, 172, 252),  # Correct goal if 4 boxer - 4 * 63 = 252
        }
    ...
    def reset(
        ...
        self.target_direction = random.randint(1, 4)
