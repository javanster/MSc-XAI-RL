...
class GoldRun(Env):
    ...
    def __init__(
        ...
        self.LAVA_PENALTY = -0.6
        self.GOLD_REWARD = 0.263
    ...
    def _get_new_agent_pos(self):
        ...
        return opposite_mapping.get(self.current_passage_position, (7, 13))
    ...
    def _draw_sprites(self, canvas: pygame.Surface, pix_square_size: float) -> None:
        ...
        if self.early_term_passage:
            ...
            if self.early_term_passage.x == 0:
                rotation_degrees = 90
            elif self.early_term_passage.y == 14:
                rotation_degrees = 180
            elif self.early_term_passage.x == 14:
                rotation_degrees = 270
