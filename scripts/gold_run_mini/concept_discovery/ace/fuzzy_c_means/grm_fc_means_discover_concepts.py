...
def grm_fc_means_cluster() -> None:
    ...
    for target_class, class_obs_path in zip(target_classes, class_obs_paths):
        ...
        fc_means_example_clusterer.cluster(
            ...
            save_directory_path=f"rl_ace_data/concept_examples/fuzzy_c_means/gold_run_mini/model_of_interest_target_class_{target_class}_observations_CONV_FLATTENED/",
        )
