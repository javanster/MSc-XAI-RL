...
if __name__ == "__main__":
    base_path = f"/Volumes/work/rl_tcav_data/concept_examples/gold_run_mini/ace_k_means/model_of_interest_target_class_{TARGET_CLASS}_observations/dim_reduction/"
    ...
    total_iterations = len(model.layers) * 49
    ...
    data_base_save_path = f"rl_ace_data/concept_examples/gold_run_mini/k_means/model_of_interest_target_class_{TARGET_CLASS}_observations/dim_reduction/"
