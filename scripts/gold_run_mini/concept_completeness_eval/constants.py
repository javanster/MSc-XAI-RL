...
MODEL_OF_INTEREST_NAME = "firm-mountain-13"
DATASETS_CCM_DIR_PATH = f"rl_ccm_data/obs_action_set/gold_run_mini/{MODEL_OF_INTEREST_NAME}/"
ENV_LAVA_SPOTS = 8
CCM_SCORES_DIR_PATH = f"rl_ccm_data/completeness_scores/gold_run_mini/{MODEL_OF_INTEREST_NAME}/"
