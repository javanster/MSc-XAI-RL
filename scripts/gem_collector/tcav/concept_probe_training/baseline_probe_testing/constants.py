...
VALIDATION_DATASET_PATHS = [
    ...
    "rl_tcav_data/cavs/baseline_concept_probes_experiment/gem_collector/validation_sets/lava_1_above_probe_validation_dataset_method3.npy",
]
VALIDATION_LABEL_SET_PATHS = [
    ...
    "rl_tcav_data/cavs/baseline_concept_probes_experiment/gem_collector/validation_sets/lava_1_above_probe_validation_label_set_method3.npy",
]
