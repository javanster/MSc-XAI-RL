...
if __name__ == "__main__":
    ...
    minecart_n_datasets = load_numpy_arrays_from_paths(
        paths=CONCEPT_EXAMPLE_PATHS,
        array_filename_prefix="continuous_concept_minecarts_n",
        array_filename_ending="examples",
    )

    pos_minecart_1_left_datasets = load_numpy_arrays_from_paths(
        paths=CONCEPT_EXAMPLE_PATHS,
        array_filename_prefix="binary_concept_minecart_1_left",
        array_filename_ending="positive_examples",
    )

    neg_minecart_1_left_datasets = load_numpy_arrays_from_paths(
        paths=CONCEPT_EXAMPLE_PATHS,
        array_filename_prefix="binary_concept_minecart_1_left",
    ...
    get_and_save_concept_example_activations(
        approach_datasets=minecart_n_datasets, model=model, concept_name="minecart_n"
    )
    get_and_save_concept_example_activations(
        approach_datasets=pos_minecart_1_left_datasets,
        model=model,
        concept_name="minecart_1_left_positive",
    )
    get_and_save_concept_example_activations(
        approach_datasets=pos_minecart_1_left_datasets,
        model=model,
        concept_name="minecart_1_left_negative",
    )
