...
def eval_ace_fc_means_concepts():
    ...
    Y_train = np.load(
        "rl_ccm_data/obs_action_set/minecart_counter/kind-cosmos-35/Y_train_8000_labels.npy"
    )
    Y_val = np.load(
        "rl_ccm_data/obs_action_set/minecart_counter/kind-cosmos-35/Y_val_2000_labels.npy"
    )
