...
def eval_ace_fc_means_concepts_nn():
    ...
    Y_train = np.load(
        "rl_ccm_data/obs_action_set/minecart_counter/kind-cosmos-35/Y_all_q_train_8000_examples.npy"
    )
    Y_val = np.load(
        "rl_ccm_data/obs_action_set/minecart_counter/kind-cosmos-35/Y_all_q_val_2000_examples.npy"
    )
