...
TARGET_CLASS = "downright"

if __name__ == "__main__":
    base_path = f"rl_tcav_data/concept_examples/minecart_counter/ace_k_means/model_of_interest_target_class_{TARGET_CLASS}_observations/dim_reduction/"
    ...
    data_base_save_path = f"rl_ace_data/concept_examples/minecart_counter/k_means/model_of_interest_target_class_{TARGET_CLASS}_observations/dim_reduction/"
